...
--        {description = "toggle wibox", group = "awesome"}),
    ...
    awful.key({ modkey }, "d",
    function ()
        awful.spawn(string.format("dmenu_run -b -i -nb '#3f3f3f' -nf '#7f9f7f' -sb '#7f9f7f' -sf '#191919' -fn HackNerdFont:pixelsize=12",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
...
awful.rules.rules = {
    ...
    -- Set geany to always map on the tag named "4" on screen 1.
    { rule = { class = "geany" },
