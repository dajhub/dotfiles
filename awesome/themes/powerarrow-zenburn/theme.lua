--[[
     ...
     Powerarrow Dark Zenburn Awesome WM theme
     github.com/lcpz
...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-zenburn"
...
-- Net
--slocal neticon = wibox.widget.imagebox(theme.widget_net)
--slocal net = lain.widget.net({
--s    settings = function()
--s        widget:set_markup(markup.font(theme.font,
--s                          markup("#7AC82E", " " .. string.format("%06.1f", net_now.received))
--s                          .. " " ..
--s                          markup("#46A8C3", " " .. string.format("%06.1f", net_now.sent) .. " ")))
--s    end
--s})
