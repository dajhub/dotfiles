...
theme.exit_screen_font = "Iosevka Nerd Font Mono 90"
...
theme.taglist_fg_empty = theme.clr.grey
...
--local spotify_play_icon = '/home/david/.local/share/icons/Tela-dark/24/actions/player_play.svg'
--local spotify_pause_icon = '/home/david/.local/share/icons/Tela-dark/24/actions/player_pause.svg'
...
-- power
local power_menu = { }
local power = wibox.widget.textbox('<span font="'..theme.icon_font..'" color="'..theme.clr.grey..'"> </span>')
